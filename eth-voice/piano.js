    ...
    (function() {
        ...
        async function play() {
            ...
            subscription.on('data', data => {
                ...
                let ori_total = parseInt(data.newBlockMined.total);
                let remainder = ori_total % 26;
                if (remainder > 13) {
                    remainder = remainder - 26;
                }
                console.log('Received eth newBlockMined with total: ' + ori_total + " and will play index " + remainder);
                $keys.trigger('note-'+remainder+'.play');
            });
        }
